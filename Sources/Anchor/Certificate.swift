...
extension X509 {
    internal final class _Certificate {
        ...
        internal var reference: UnsafeMutablePointer<CCryptoBoringSSL.X509> {
            return self._reference.assumingMemoryBound(to: CCryptoBoringSSL.X509.self)
        }
        
        private init(withOwnedReference reference: UnsafeMutablePointer<CCryptoBoringSSL.X509>) {
        ...
        internal convenience init(bytes: [UInt8], format: Certificate.SerializationFormat) throws {
            let ref = bytes.withUnsafeBytes { (ptr) -> UnsafeMutablePointer<CCryptoBoringSSL.X509>? in
